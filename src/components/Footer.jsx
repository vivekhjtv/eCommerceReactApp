              ...
              <div className="row g-4">
                ...
                <div className="col-6 col-sm-6 col-md-3">
                  ...
                  <ul className="nav flex-column">
                    ...
                    <li className="nav-item mb-2">
                      <Link to="shop-checkout.html" className="nav-link">
                        Shop Checkout
                      </Link>
                    </li>
                  </ul>
              ...
              <div className="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
                <ul className="list-inline mb-0">
                  ...
                  <li className="list-inline-item">
                    <Link to="#!">
                      <img
                        src={`${IMAGE_PREFIX}/payment/amazonpay.svg`}
                        alt=""
                      />
                    </Link>
                  </li>
                  <li className="list-inline-item">
                    <Link to="#!">
                      <img
                        src={`${IMAGE_PREFIX}/payment/american-express.svg`}
                        alt=""
                      />
                    </Link>
                  </li>
                  <li className="list-inline-item">
                    <Link to="#!">
                      <img
                        src={`${IMAGE_PREFIX}/payment/mastercard.svg`}
                        alt=""
                      />
                    </Link>
                  </li>
                  <li className="list-inline-item">
                    <Link to="#!">
                      <img src={`${IMAGE_PREFIX}/payment/paypal.svg`} alt="" />
                    </Link>
                  </li>
                  <li className="list-inline-item">
                    <Link to="#!">
                      <img src={`${IMAGE_PREFIX}/payment/visa.svg`} alt="" />
                    </Link>
                  </li>
                </ul>
              </div>
              <div className="col-lg-7 mt-4 mt-md-0">
                <ul className="list-inline mb-0 text-lg-end text-center">
                  ...
                  <li className="list-inline-item ms-4">
                    <Link to="#!">
                      <img
                        src={`${IMAGE_PREFIX}/appbutton/appstore-btn.svg`}
                        alt=""
                        style={{ width: "140px" }}
                      />
                    </Link>
                  ...
                  <li className="list-inline-item">
                    <Link to="#!">
                      <img
                        src={`${IMAGE_PREFIX}/appbutton/googleplay-btn.svg`}
                        alt=""
                        style={{ width: "140px" }}
                      />
                    </Link>
            ...
            <div className="row align-items-center">
              <div className="col-md-6">
                <span className="small text-muted">
                  ...
                  FreshCart eCommerce HTML Template. All rights reserved.
                  Powered by
                  <Link
